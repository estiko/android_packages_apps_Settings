...
public class ScreenRecorderSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        String size = Settings.XOPLAX.getString(resolver,
                Settings.XOPLAX.SCREEN_RECORDER_OUTPUT_DIMENSIONS);
        ...
        String rate= Settings.XOPLAX.getString(resolver,
                Settings.XOPLAX.SCREEN_RECORDER_BITRATE);
        updateVideoBitratePreference(rate);

        mRecordAudioPref = (CheckBoxPreference) findPreference(KEY_RECORD_AUDIO);
        mRecordAudioPref.setChecked(Settings.XOPLAX.getInt(resolver,
                Settings.XOPLAX.SCREEN_RECORDER_RECORD_AUDIO, 0) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        if (preference == mVideoSizePref) {
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.SCREEN_RECORDER_RECORD_AUDIO,
