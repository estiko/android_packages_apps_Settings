...
public class ScrollAnimationInterfaceSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnimNoScroll.setChecked(Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ANIMATION_CONTROLS_NO_SCROLL, 0) == 1);
        mAnimNoScroll.setOnPreferenceChangeListener(this);

        float defaultScroll = Settings.XOPLAX.getFloat(mResolver,
                Settings.XOPLAX.CUSTOM_SCROLL_FRICTION, ViewConfiguration.DEFAULT_SCROLL_FRICTION);
        ...
        int defaultFling = Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.CUSTOM_FLING_VELOCITY, ViewConfiguration.DEFAULT_MAXIMUM_FLING_VELOCITY);
        ...
        int defaultOverScroll = Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.CUSTOM_OVERSCROLL_DISTANCE, ViewConfiguration.DEFAULT_OVERSCROLL_DISTANCE);
        ...
        int defaultOverFling = Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.CUSTOM_OVERFLING_DISTANCE, ViewConfiguration.DEFAULT_OVERFLING_DISTANCE);
        ...
        int intColor = Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.OVERSCROLL_GLOW_COLOR, defaultColor);
    ...
    private void resetAllSettings() {
        ...
        Settings.XOPLAX.putFloat(mResolver,
                   Settings.XOPLAX.CUSTOM_SCROLL_FRICTION, ViewConfiguration.DEFAULT_SCROLL_FRICTION);
        ...
        Settings.XOPLAX.putInt(mResolver,
                   Settings.XOPLAX.OVERSCROLL_GLOW_COLOR, DEFAULT_OVERSCROLL_COLOR);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mAnimNoScroll) {
            ...
            Settings.XOPLAX.putInt(mResolver, Settings.XOPLAX.ANIMATION_CONTROLS_NO_SCROLL, value ? 1 : 0);
        } else if (preference == mAnimationScroll) {
            int val = ((Integer)objValue).intValue();
            Settings.XOPLAX.putFloat(mResolver,
                   Settings.XOPLAX.CUSTOM_SCROLL_FRICTION,
                   ((float) (val / MULTIPLIER_SCROLL_FRICTION)));
        } else if (preference == mAnimationFling) {
            int val = ((Integer)objValue).intValue();
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.CUSTOM_FLING_VELOCITY,
                    val);
        } else if (preference == mAnimationOverScroll) {
            int val = ((Integer)objValue).intValue();
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.CUSTOM_OVERSCROLL_DISTANCE,
                    val);
        } else if (preference == mAnimationOverFling) {
            int val = ((Integer)objValue).intValue();
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.CUSTOM_OVERFLING_DISTANCE,
                    val);
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.OVERSCROLL_GLOW_COLOR, intHex);
        } else {
            return false;
        }
        return true;
    ...
    private void setProperVal(Preference preference, int val) {
        String mString = "";
        if (preference == mAnimNoScroll) {
            mString = Settings.XOPLAX.ANIMATION_CONTROLS_NO_SCROLL;
        } else if (preference == mAnimationFling) {
            mString = Settings.XOPLAX.CUSTOM_FLING_VELOCITY;
        } else if (preference == mAnimationOverScroll) {
            mString = Settings.XOPLAX.CUSTOM_OVERSCROLL_DISTANCE;
        } else if (preference == mAnimationOverFling) {
            mString = Settings.XOPLAX.CUSTOM_OVERFLING_DISTANCE;
        }
