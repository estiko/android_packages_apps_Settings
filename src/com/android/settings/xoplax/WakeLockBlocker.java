...
public class WakeLockBlocker extends SettingsPreferenceFragment {
        ...
        mBlockerEnabled
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton v, boolean checked) {
                        ...
                        Settings.XOPLAX.putInt(mContext.getContentResolver(), Settings.XOPLAX.WAKELOCK_BLOCKING_ENABLED,
                                checked?1:0);
    ...
    private boolean isFirstEnable() {
        return Settings.XOPLAX.getString(mContext.getContentResolver(),
                Settings.XOPLAX.WAKELOCK_BLOCKING_ENABLED) == null;
    }

    private void updateSwitches() {
        mBlockerEnabled.setChecked(Settings.XOPLAX.getInt(mContext.getContentResolver(),
                Settings.XOPLAX.WAKELOCK_BLOCKING_ENABLED, 0)==1?true:false);
    ...
    private void updateBlockedWakeLocksList() {
        String blockedWakelockList = Settings.XOPLAX.getString(mContext.getContentResolver(),
    ...
    private void save(){
        ...
        Settings.XOPLAX.putString(mContext.getContentResolver(),
                Settings.XOPLAX.WAKELOCK_BLOCKING_LIST, buffer.toString());
    }
