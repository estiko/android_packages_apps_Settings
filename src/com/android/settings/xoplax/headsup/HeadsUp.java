...
public class HeadsUp extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHeadsUpExpanded.setChecked(Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_EXPANDED, 0, UserHandle.USER_CURRENT) == 1);
        ...
        mHeadsUpShowUpdates.setChecked(Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_SHOW_UPDATE, 0, UserHandle.USER_CURRENT) == 1);
        ...
        mHeadsUpGravity.setChecked(Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_GRAVITY_BOTTOM, 0, UserHandle.USER_CURRENT) == 1);
        ...
        mHeadsExcludeFromLockscreen.setChecked(Settings.XOPLAX.getIntForUser(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_EXCLUDE_FROM_LOCK_SCREEN, 0, UserHandle.USER_CURRENT) == 1);
        mHeadsExcludeFromLockscreen.setOnPreferenceChangeListener(this);

        mHeadsUpSnoozeTime = (ListPreference) findPreference(PREF_HEADS_UP_SNOOZE_TIME);
        mHeadsUpSnoozeTime.setOnPreferenceChangeListener(this);
        int headsUpSnoozeTime = Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_SNOOZE_TIME, DEFAULT_TIME_HEADS_UP_SNOOZE);
        ...
        int headsUpTimeOut = Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_NOTIFCATION_DECAY, defaultTimeOut);
        ...
        final int intColor = Settings.XOPLAX.getInt(getContentResolver(),
        ...
        final int intTextColor = Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_TEXT_COLOR, 0x00000000);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mHeadsUpSnoozeTime) {
            ...
            Settings.XOPLAX.putIntForUser(getContentResolver(),
            ...
            Settings.XOPLAX.putIntForUser(getContentResolver(),
                    Settings.XOPLAX.HEADS_UP_EXCLUDE_FROM_LOCK_SCREEN,
                    (Boolean) objValue ? 1 : 0, UserHandle.USER_CURRENT);
            return true;
    ...
    private void resetValues() {
        Settings.XOPLAX.putInt(getContentResolver(),
                Settings.XOPLAX.HEADS_UP_BG_COLOR, DEFAULT_BACKGROUND_COLOR);
